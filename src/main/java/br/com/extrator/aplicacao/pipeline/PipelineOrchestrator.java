...
public final class PipelineOrchestrator {
    ...
    private List<StepRunOutcome> executarCoreEmParalelo(final PipelineStep stepA,
        ...
        try {
            final Future<StepRunOutcome> futureA = executor.submit(() -> executarStepComPoliticas(stepA, dataInicio, dataFim));
            final Future<StepRunOutcome> futureB = executor.submit(() -> executarStepComPoliticas(stepB, dataInicio, dataFim));
