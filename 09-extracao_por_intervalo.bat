...
REM ================================================================
REM Script: 09-extracao_por_intervalo.bat
REM Finalidade:
...
REM
REM Uso:
REM   09-extracao_por_intervalo.bat
REM   09-extracao_por_intervalo.bat YYYY-MM-DD YYYY-MM-DD
REM   09-extracao_por_intervalo.bat YYYY-MM-DD YYYY-MM-DD api
REM   09-extracao_por_intervalo.bat YYYY-MM-DD YYYY-MM-DD api entidade
REM
REM Exemplos:
REM   09-extracao_por_intervalo.bat 2024-10-26 2024-12-26
REM   09-extracao_por_intervalo.bat 2024-10-26 2024-12-26 dataexport
REM   09-extracao_por_intervalo.bat 2024-10-26 2024-12-26 dataexport localizacao_cargas
REM
REM Funcionalidades:
...
if "%DATA_INICIO%"=="" (
    ...
    echo.
    echo Uso: 09-extracao_por_intervalo.bat [DATA_INICIO] [DATA_FIM] [API] [ENTIDADE]
    echo Exemplo: 09-extracao_por_intervalo.bat 2024-10-26 2024-12-26 dataexport localizacao_cargas
    pause
    exit /b 1
)
