...
- Orquestracao complementar: chamada pelo `MATERIALIZAR_FATOS_BI_POST_RUN`, por `database/executar_database.bat --com-cargas` e pela janela noturna resiliente de `10-expurgo-orfaos-noturno.ps1`.
