-- ============================================
-- Publica wrappers locais do Dashboard DEV com colunas explicitas.
--
-- Uso:
--   sqlcmd -S <server> -d master -i database\views\023_publicar_wrappers_dashboard_dev_explicitos.sql ^
--     -v DashboardDb="DASHBOARDS_DEV" EtlDb="ETL_SISTEMA"
--
...
:setvar DashboardDb "DASHBOARDS_DEV"
...
FROM [$(EtlDb)].dbo.' + QUOTENAME(@nome) + N';';
    ...
    PRINT N'Wrapper atualizado com colunas explicitas: dbo.' + @nome;
...
PRINT N'Wrappers explicitos do Dashboard DEV publicados com sucesso.';
GO
