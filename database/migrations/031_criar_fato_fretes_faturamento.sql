PRINT 'Migration 031: criar fato granular de faturamento de fretes';
GO
...
DECLARE @MigrationId NVARCHAR(255) = N'031_criar_fato_fretes_faturamento';
...
BEGIN
    PRINT 'Migracao 031_criar_fato_fretes_faturamento ja aplicada. Nenhuma acao necessaria.';
    RETURN;
END;
...
VALUES (
    @MigrationId,
    N'Cria fato granular de faturamento por frete, com flag de CT-e cancelado, valores zerados para inelegiveis e indices para paginacao por data de faturamento.'
);

PRINT 'Migration 031_criar_fato_fretes_faturamento concluida com sucesso.';
GO
