PRINT 'Migration 032: criar fato materializada de Gestao a Vista para faturas';
GO
...
DECLARE @MigrationId NVARCHAR(255) = N'032_criar_fato_gestao_vista_faturas';
...
BEGIN
    PRINT 'Migracao 032_criar_fato_gestao_vista_faturas ja aplicada. Nenhuma acao necessaria.';
    RETURN;
END;
...
VALUES (
    @MigrationId,
    N'Cria fato materializada de faturas por titulo, particionada por data_emissao_fatura e otimizada para Aging e Tabela do Dashboard.'
);

PRINT 'Migration 032_criar_fato_gestao_vista_faturas concluida com sucesso.';
GO
