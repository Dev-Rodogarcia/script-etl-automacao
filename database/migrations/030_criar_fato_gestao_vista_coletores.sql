PRINT 'Migration 030: criar fato materializada de Gestao a Vista para coletores';
GO
...
DECLARE @MigrationId NVARCHAR(255) = N'030_criar_fato_gestao_vista_coletores';
...
BEGIN
    PRINT 'Migracao 030_criar_fato_gestao_vista_coletores ja aplicada. Nenhuma acao necessaria.';
    RETURN;
END;
...
VALUES (
    @MigrationId,
    N'Cria tabela fato materializada para Utilizacao de Coletores, particionada por data_referencia e otimizada com columnstore.'
);

PRINT 'Migration 030_criar_fato_gestao_vista_coletores concluida com sucesso.';
GO
